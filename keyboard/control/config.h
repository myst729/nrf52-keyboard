...
#define PRODUCT_ID 0xD702 /* USB PID */
...
#define PRODUCT "Control" /* 硬件名称，用于USB和蓝牙显示 */
#define DEVICE_BLE_APPEARANCE BLE_APPEARANCE_HID_GAMEPAD
#define MACADDR_SEPRATOR '_' /* 蓝牙名称后地址的分隔符。若不设置则不显示蓝牙名称后面的地址 */

/* Key Matrix */
#define MATRIX_ROWS 1 /* 硬件阵列行数 */
#define MATRIX_COLS 4 /* 硬件阵列列数 */
static const uint8_t row_pin_array[MATRIX_ROWS] = { 4 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 5, 6, 7, 8 };
