...
#define PRODUCT_ID 0xD804 /* USB PID */
#define CONF_VENDOR_ID 0x9A29 /* 配置项目内显示的VendorID */
#define CONF_PRODUCT_ID 0x9804 /* 配置项目内显示的ProductID */
#define DEVICE_VER 0x0001 /* 硬件版本 */
#define MANUFACTURER "Leo Deng" /* 硬件制造商，用于蓝牙显示 */
#define PRODUCT "Happy Hacking" /* 硬件名称，用于USB和蓝牙显示 */
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 9, 8, 7, 3 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 30, 29, 11, 4, 5, 6, 12, 16, 22, 23, 24, 15 };
...
/* Simple RGB Status */
#define LED_RGB_R 19 // 红色引脚
#define LED_RGB_G 18 // 绿色引脚
#define LED_RGB_B 20 // 蓝色引脚
