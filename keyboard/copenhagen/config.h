...
#define PRODUCT "Copenhagen" /* 硬件名称，用于USB和蓝牙显示 */
...
// 启用 LED 状态灯
// #define LED_STATUS_BLE 18 // 蓝牙连接指示灯
// #define LED_STATUS_USB 19 // USB连接状态指示灯
...
static const uint8_t row_pin_array[MATRIX_ROWS] = { 22, 25, 24, 23 };
static const uint8_t column_pin_array[MATRIX_COLS] = { 14, 13, 12, 11, 3, 4, 5, 6, 7, 8, 28, 21 };
...
static const struct ledmap_event ledmap_events[] = {
  ...
  },
  {
    ...
    .param = BATT_CHARGED,
    .led_mask = 0x04,
    .action = { .priority = 0, .action = TRIG_LED_BLINK_FOREVER(0) },
  },
};
#endif
